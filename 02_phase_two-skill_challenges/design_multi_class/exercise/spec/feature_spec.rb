...
describe Contacts do
  describe '#contacts' do
    it 'returns an array of contacts' do
      iphone = Contacts.new
      contact_1 = Contact.new('Bob', 37_462_836_421)
      contact_2 = Contact.new('Jill', 47_582_937_182)
...
describe Diary do
  ...
  describe '#check_diary_for_phone_numbers' do
    it 'returns all of the entries that contain numbers found in a certain contacts list' do
      ...
      contact1 = Contact.new('Bob', 46_372_364_831)
      contact2 = Contact.new('Jill', 36_473_920_463)
      contact3 = Contact.new('Fred', 29_462_950_321)
